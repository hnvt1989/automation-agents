-- Supabase Schema for Tasks and Daily Logs Management
...
CREATE POLICY "Enable all operations for authenticated users" ON daily_logs
    FOR ALL USING (auth.role() = 'authenticated');

-- If you want public access (for development), use these instead:
-- CREATE POLICY "Enable all operations for all users" ON tasks
--     FOR ALL USING (true);
-- 
-- CREATE POLICY "Enable all operations for all users" ON daily_logs
--     FOR ALL USING (true);